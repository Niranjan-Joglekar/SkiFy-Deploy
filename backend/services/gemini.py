...
# genai.configure(api_key="AIzaSyA6SSlQ4MtNwUMvm24Jt-IpseczCd6OHPE")
...
# def generate_question(topic: str, level: int):
#     difficulty_label = {
#         1: "very easy",
#         2: "easy",
#         3: "medium",
...
#     prompt = f"""
#     Generate 1 {difficulty_label} level multiple-choice question on the topic of {topic}.
#     Include 4 options labeled 1 to 4 and the correct option number as 'correct_option'.
...
#       "correct_option": "2"
#     }}
#     Do not include markdown formatting or explanations and do not repeat questions.
